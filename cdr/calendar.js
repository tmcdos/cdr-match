...
function attachListener() 
{
	...
	if (window.popOldEvent != null) 
	{
	  if(document.addEventListener) document.addEventListener('mouseup', oldEvent, false);
	    else document.attachEvent('onmouseup', oldEvent);
	}
 	else 
 	{
 	  if(document.addEventListener) document.addEventListener('mouseup', newEvent, false);
 	    else document.attachEvent('onmouseup', newEvent);
 	}
}
...
{ 
	...
	else alert('Use setReturnMonthFunction() to define which function will get the clicked results!\nYou clicked: year='+y+' , month='+m); 
}
